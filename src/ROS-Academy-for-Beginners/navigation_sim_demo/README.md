...
最后，启动rviz可视化工具
	...
	roslaunch navigation_sim_demo view_navigation.launch #这种方法需要在rviz中手动选择一个大致的初值，AMCL才会在初值周围生成大量粒子，进行定位


然后，推荐使用global_localization service，在使用时max_particles建议设在一个比较大的值，比如50000
