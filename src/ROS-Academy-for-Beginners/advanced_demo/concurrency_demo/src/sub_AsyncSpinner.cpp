...
/// when thread_count >= 2 or thread_count == 0 (0 means A value of 0 means to use the number of processor cores)
...
/// when thread_count >= 2 or thread_count == 0 (means A value of 0 means to use the number of processor cores)
